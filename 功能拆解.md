...
- **前端 (`RoleVerificationModal.jsx`):**
    - [ ] 创建 `RoleVerificationModal.jsx` 组件或类似视图。
    - [ ] 显示从后端收到的澄清性问题。
    - [ ] 提供“确认”和“修正”按钮。
...
- **后端 (配置):**
    ...
    - [ ] 此端点接收最终设置（如难度），并将 `InterviewSessions` 状态更新为 `IN_PROGRESS`。
    - [ ] 触发生成第一个面试问题的内部逻辑。
